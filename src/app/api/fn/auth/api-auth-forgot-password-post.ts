...
export function apiAuthForgotPasswordPost(http: HttpClient, rootUrl: string, params?: ApiAuthForgotPasswordPost$Params, context?: HttpContext): Observable<StrictHttpResponse<PasswordResetResponseDtoApiResponse>> {
